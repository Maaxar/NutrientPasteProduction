...
v0.1.2.0 - Updated to support RimWorld version 1.1. Renamed "Nutrient paste meal (refined)" to "Refined paste meal". Added the ability to make nutrient paste meals and refined paste meals at the regular electric stove. "Packaged Survival Meal" research must be now be completed before the "Refined paste meal" recipe is available. Refined Paste no longer rots. Refined Paste no longer takes twice as much time to make, instead it takes twice as much raw material.