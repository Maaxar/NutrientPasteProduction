...
v0.1.2.0 - Updated to support RimWorld version 1.1. Renamed "Nutrient paste meal (refined)" to "Refined paste meal". Added the ability to make nutrient paste meals and refined paste meals at the regular electric stove. "Packaged Survival Meal" research must now be completed before the "Refined paste meal" recipe is available. Refined paste meals no longer rot. Refined paste meal recipes no longer take twice as much time to make, instead they takes twice as much raw material as ingredients.